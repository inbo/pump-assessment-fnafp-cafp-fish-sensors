...
```{r}
if (file.exists("./data/internal/Oude_Kale/BDS_TalTech/Manually_changed_ROI.csv")) {
 unlink("./data/internal/Oude_Kale/BDS_TalTech/Manually_changed_ROI.csv")
...
```{r}
if (file.exists("data/internal/Oude_Kale/BDS_TalTech/All_BDS_data_OK.csv")==FALSE){
  list.dir<-list.dirs(path = "./data/external/Oude_Kale/BDS_TalTech/Devils_Hole_BDS_Post-Processing/")
  for (i in 2:length(list.dir)){
    ...
    for (j in 1:length(list.file)){
      ...
      file.temp$scenario<-str_split(list.file[j],"/")[[1]][7]
      file.temp$sensor<-gsub(".csv","",str_split(list.file[j],"/")[[1]][8])
...
} else {file.complete<-read.csv("data/internal/Oude_Kale/BDS_TalTech/All_BDS_data_OK.csv")}
rm(file.temp)
```
...
```{r}
write.csv(file.final,"data/internal/Oude_Kale/BDS_TalTech/All_BDS_data_final_OK.csv")
write.csv(file.final.injection.nadir.wide,"data/internal/Oude_Kale/BDS_TalTech/All_BDS_data_ROIs_OK.csv")
write.csv(file.final.injection.nadir,"data/internal/Oude_Kale/BDS_TalTech/All_BDS_data_ROIs_OK_long.csv")
```
