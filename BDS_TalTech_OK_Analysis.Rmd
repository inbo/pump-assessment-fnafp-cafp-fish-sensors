...
```{r}
file.final.injection.nadir.wide <- read.csv("data/internal/Oude_Kale/BDS_TalTech/All_BDS_data_ROIs_OK.csv")
...
```{r}
cmpr<-list(c('Axial','F/N - 468 rpm'),        
 c('Axial','F/N - 550 rpm'),        
 c('F/N - 468 rpm','F/N - 550 rpm')
 )
...
```{r}
cmpr<-list(c('Axial','F/N - 468 rpm Ctrl'),
 c('Axial','F/N - 468 rpm'),        
 c('Axial','F/N - 550 rpm Ctrl'),
 c('Axial','F/N - 550 rpm'),        
 c('F/N - 468 rpm Ctrl','F/N - 468 rpm'),        
 c('F/N - 468 rpm Ctrl','F/N - 550 rpm Ctrl'),
 c('F/N - 468 rpm Ctrl','F/N - 550 rpm'),
 c('F/N - 468 rpm','F/N - 550 rpm'),
 c('F/N - 468 rpm','F/N - 550 rpm Ctrl'),
 c('F/N - 550 rpm Ctrl','F/N - 550 rpm')
 )
symnum.args <- list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, Inf), symbols = c("****", "***", "**", "*", "ns"))
```
...
```{r}
pdf("./figures/Oude_Kale/BDS_boxplots.pdf",height = 12)
library(grid)
grid.newpage()
...
```{r}
pdf("./figures/Oude_Kale/CDF_Nadir.pdf")
...
k
l
pdf("./figures/Oude_Kale/timeseries_all.pdf")
ggarrange(g,h,common.legend = TRUE,ncol=1)
dev.off()
pdf("./figures/Oude_Kale/timeseries_selection.pdf")
