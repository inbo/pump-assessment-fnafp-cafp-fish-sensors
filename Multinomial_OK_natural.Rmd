...
df_OK_n_ad <- read.csv("./data/internal/df_OK_n_ad.csv")
...
df_OK_n_ad_long_type <- read.csv("./data/internal/df_OK_n_ad_long_type.csv")
...
df_OK_n_ad_long <- read.csv("./data/internal/df_OK_n_ad_long.csv")
