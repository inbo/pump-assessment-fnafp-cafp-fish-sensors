...
```{r include=FALSE}
specieslist_OK <- read.csv("./data/internal/specieslist_OK.csv")
```
...
if (RUN==TRUE){
  ...
  for(i in specieslist_OK[,2]){
    ...
    for (j in fish){
      ...
      filename=paste("./data/internal/power/power_",i,"_",j,"fish.csv",sep="")
...
```{r}
filelist<-list.files("./data/internal/power/")
for (i in 1:length(filelist)){
  filename=paste("./data/internal/power/",filelist[i],sep="")
