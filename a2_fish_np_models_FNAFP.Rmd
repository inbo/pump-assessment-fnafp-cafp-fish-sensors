...
df_OK_f_stat_level2a <- read.csv("./data/fish/internal/additional/df_OK_f_stat_level2a.csv")
```
...
df_OK_f_stat_level2a_wide<-read.csv("./data/fish/internal/NP/df_OK_f_stat_level2a_wide.csv")[,-c(1)]
df_OK_f_stat_level2a_wide_species_pump<-read.csv("./data/fish/internal/NP/df_OK_f_stat_level2a_wide_species_pump.csv")[,-1]
df_OK_f_stat_level2a_wide_freq_pump<-read.csv("./data/fish/internal/NP/df_OK_f_stat_level2a_wide_freq_pump.csv")[,-1]
```
