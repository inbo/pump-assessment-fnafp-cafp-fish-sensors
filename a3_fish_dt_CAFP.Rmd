...
```{r}
df_OK_f_long_type <- read.csv("./data/fish/internal/additional/df_OK_f_long_type.csv")
df_OK_n_ad_long_type <- read.csv("./data/fish/internal/additional/df_OK_n_ad_long_type.csv")
...
df_OK_f_long <- read.csv("./data/fish/internal/additional/df_OK_f_long.csv")
df_OK_n_ad_long <- read.csv("./data/fish/internal/additional/df_OK_n_ad_long.csv")
