---
title: "fish_logistic_models_FNAFP"
...
# df_OK_f$Pump_type_rpm <- relevel(df_OK_f$Pump_type_rpm, ref = "FNAFP - 468 rpm")
...
for(i in specieslist_OK){
  ...
  print(ggplot(df_OK_f_temp[which(df_OK_f_temp$Pump_type_rpm=="FNAFP - 468 rpm"),], aes(Length,logit)) + geom_point(size = 0.5, alpha = 0.5) + geom_smooth(method = "loess"))
  print(ggplot(df_OK_f_temp[which(df_OK_f_temp$Pump_type_rpm=="FNAFP - 550 rpm"),], aes(Length,logit)) + geom_point(size = 0.5, alpha = 0.5) + geom_smooth(method = "loess"))
