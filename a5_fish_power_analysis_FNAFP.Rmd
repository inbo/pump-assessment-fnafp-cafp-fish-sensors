---
title: "fish_power_analysis_FNAFP"
...
```{r}
RUN=TRUE #if run is true than the power analysis will be performed, if run is false the power analysis will be skipped and the stored data will be used for the visualisation
```
