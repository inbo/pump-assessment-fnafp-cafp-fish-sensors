...
if (Remove_too_few_samples=="YES"){
  df_OK_f_temp_too_few_samples <- read.csv("./data/fish/internal/df_OK_f_too_few_samples.csv")[,c("Species","Pump_type","rpm","Control","Fin_cut")]
...
write.csv(specieslist_OK,"./data/fish/internal/additional/specieslist_OK.csv")
write.csv(injurylist_OK,"./data/fish/internal/additional/injurylist_OK.csv")
write.csv(injurylist_type_OK,"./data/fish/internal/additional/injurylist_type_OK.csv")
