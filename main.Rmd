...
write.csv(df_OK_f_stat_level2a_wide,"./data/internal/df_OK_f_stat_level2a_wide.csv")
...
df_OK_f_stat_level2a_wide_species_pump <- as.data.frame(stats_data_level2a(df_OK_f_stat_level2a,c("Species", "Pump_type", "Control", "State")) %>% 
  ...
  spread(State,number_state_binom)) 
write.csv(df_OK_f_stat_level2a_wide_species_pump,"./data/internal/df_OK_f_stat_level2a_wide_species_pump.csv")
...
df_OK_f_stat_level2a_wide_freq_pump <- as.data.frame(stats_data_level2a(df_OK_f_stat_level2a,c("rpm", "Pump_type","Control" ,"State")) %>% 
  ...
  spread(State,number_state_binom)) 
write.csv(df_OK_f_stat_level2a_wide_freq_pump,"./data/internal/df_OK_f_stat_level2a_wide_freq_pump.csv")
...
write.csv(df_OK_f_stat_level3,"./data/internal/df_OK_f_stat_level3.csv")
```
...
write.csv(df_OK_f_stat_level3b,"./data/internal/df_OK_f_stat_level3b.csv")
```
