...
```{r}
write.csv(df_OK_f_bream,"./data/internal/df_OK_f_bream.csv")
write.csv(df_OK_f_roach,"./data/internal/df_OK_f_roach.csv")
write.csv(df_OK_f_eel,"./data/internal/df_OK_f_eel.csv")
...
write.csv(df_OK_f_stat_level1,"./data/internal/df_OK_f_stat_level1.csv")
```
...
write.csv(df_OK_f_stat_level2a,"./data/internal/df_OK_f_stat_level2a.csv")
write.csv(df_OK_f_stat_level2b,"./data/internal/df_OK_f_stat_level2b.csv")
...
write.csv(df_OK_f_long,"./data/internal/df_OK_f_long.csv")
write.csv(df_OK_f_long_type,"./data/internal/df_OK_f_long_type.csv")
write.csv(df_OK_n_ad_long,"./data/internal/df_OK_n_ad_long.csv")
write.csv(df_OK_n_ad_long_type,"./data/internal/df_OK_n_ad_long_type.csv")
write.csv(df_OK_f_stat_level1_long,"./data/internal/df_OK_f_stat_level1_long.csv")
write.csv(df_OK_f_stat_level2a_long,"./data/internal/df_OK_f_stat_level2a_long.csv")
```
...
write.csv(specieslist_OK,"./data/internal/specieslist_OK.csv")
write.csv(injurylist_OK,"./data/internal/injurylist_OK.csv")
write.csv(injurylist_type_OK,"./data/internal/injurylist_type_OK.csv")
...
df_OK_f_stat_level2a_wide_species_pump <- as.data.frame(stats_data_level2a(df_OK_f_stat_level2a,c("Species", "Pump_type", "Control", "State")) %>% 
  ...
  spread(State,number_state_binom)) 
write.csv(df_OK_f_stat_level2a_wide_species_pump,"./data/NP/internal/df_OK_f_stat_level2a_wide_species_pump.csv")
