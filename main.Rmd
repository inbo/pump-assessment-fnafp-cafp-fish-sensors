...
df_OK_f_bream <- read_excel("./data/external/processed_in_excel/geforceerde_proeven_brasem_werkelijk toerental.xlsx")
df_OK_f_roach <- read_excel("./data/external/processed_in_excel/geforceerde_proeven_bv_werkelijk toerental.xlsx")
df_OK_f_eel <- read_excel("./data/external/processed_in_excel/geforceerde_proeven_paling_werkelijk toerental.xlsx")
df_OK_f_eel <- df_OK_f_eel[-which(df_OK_f_eel$Fin_cut=="onderlip doorgesneden"),]

df_OK_n_ad <- read_excel("./data/external/processed_in_excel/natuurlijk.xlsx")
```
...
```{r}
Remove_too_few_samples <- "NO"
threshold_too_few_samples <- 5
```
...
```{r}
if (Remove_too_few_samples=="YES"){
  df_OK_f_temp_too_few_samples <- read.csv("./data/internal/df_OK_f_too_few_samples.csv")[,c("Species","Pump_type","rpm","Control","Fin_cut")]
  df_OK_f_temp_too_few_samples$rpm <- as.character(df_OK_f_temp_too_few_samples$rpm)
  df_OK_f_temp_too_few_samples$too_few_samples<-"YES"
  df_OK_f <- left_join(df_OK_f,df_OK_f_temp_too_few_samples, by=c("Species","Pump_type","rpm","Control","Fin_cut"))
  df_OK_f <- df_OK_f[-which(df_OK_f$too_few_samples=="YES"),]
}
  
```

```{r}
write.csv(df_OK_f_bream,"./data/internal/additional/df_OK_f_bream.csv")
write.csv(df_OK_f_roach,"./data/internal/additional/df_OK_f_roach.csv")
write.csv(df_OK_f_eel,"./data/internal/additional/df_OK_f_eel.csv")
write.csv(df_OK_f,"./data/internal/df_OK_f.csv")
write.csv(df_OK_n_ad,"./data/internal/df_OK_n_ad.csv")
...
if (Remove_too_few_samples=="NO"){write.csv(df_OK_f_temp_too_few_samples,"./data/internal/df_OK_f_too_few_samples.csv")}
...
write.csv(df_OK_f_stat_level1,"./data/internal/additional/df_OK_f_stat_level1.csv")
```
...
write.csv(df_OK_f_stat_level2a,"./data/internal/additional/df_OK_f_stat_level2a.csv")
write.csv(df_OK_f_stat_level2b,"./data/internal/additional/df_OK_f_stat_level2b.csv")
...
write.csv(df_OK_f_long,"./data/internal/additional/df_OK_f_long.csv")
write.csv(df_OK_f_long_type,"./data/internal/additional/df_OK_f_long_type.csv")
write.csv(df_OK_n_ad_long,"./data/internal/additional/df_OK_n_ad_long.csv")
write.csv(df_OK_n_ad_long_type,"./data/internal/additional/df_OK_n_ad_long_type.csv")
write.csv(df_OK_f_stat_level1_long,"./data/internal/additional/df_OK_f_stat_level1_long.csv")
write.csv(df_OK_f_stat_level2a_long,"./data/internal/additional/df_OK_f_stat_level2a_long.csv")
```
...
write.csv(specieslist_OK,"./data/internal/additional/specieslist_OK.csv")
write.csv(injurylist_OK,"./data/internal/additional/injurylist_OK.csv")
write.csv(injurylist_type_OK,"./data/internal/additional/injurylist_type_OK.csv")
...
write.csv(df_OK_f_stat_level2a_wide,"./data/internal/NP/df_OK_f_stat_level2a_wide.csv")
...
df_OK_f_stat_level2a_wide_species_pump <- as.data.frame(stats_data_level2a(df_OK_f_stat_level2a,c("Species", "Pump_type", "Control", "State")) %>% 
  ...
  spread(State,number_state_binom)) 
write.csv(df_OK_f_stat_level2a_wide_species_pump,"./data/internal/NP/df_OK_f_stat_level2a_wide_species_pump.csv")
...
df_OK_f_stat_level2a_wide_freq_pump <- as.data.frame(stats_data_level2a(df_OK_f_stat_level2a,c("rpm", "Pump_type","Control" ,"State")) %>% 
  ...
  spread(State,number_state_binom)) 
write.csv(df_OK_f_stat_level2a_wide_freq_pump,"./data/internal/NP/df_OK_f_stat_level2a_wide_freq_pump.csv")
...
write.csv(df_OK_f_stat_level3,"./data/internal/NP/df_OK_f_stat_level3.csv")
```
...
write.csv(df_OK_f_stat_level3b,"./data/internal/NP/df_OK_f_stat_level3b.csv")
```
